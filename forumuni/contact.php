...
?>
        <div class="col-md-8">
            <div class="card">
                <div class="card-header"><i class="fas fa-envelope"></i> İletişim</div>
                    <div class="card-body">
...
?>	    
                        ...
                        <br /><hr>
                        <center><p>Sistemde yaşadığın bir sorunla ilgili bize ulaşabilirsin.</p></center>
<?php
if (isset($_POST['send'])) {
    if ($logged == 'No') {
        $name    = $_POST['name'];
    ...
    if ($captcha) {
        ...
        if ($responseKeys["success"]) {
            ...
            if (!filter_var($email, FILTER_VALIDATE_EMAIL)) {
                ...
                echo '<div class="alert alert-success">Mesajın Başarıyla Bize Ulaştı :)</div>';
            }
        }
    }
}
...
if ($logged == 'No') {
?>
                            <label for="name"><i class="fa fa-user"></i> Adın:</label>
                            <input type="text" name="name" id="name" value="" class="form-control" required />
                            <br />
									
                            <label for="email"><i class="fa fa-envelope"></i> E-Posta Adresin:</label>
                            <input type="email" name="email" id="email" value="" class="form-control" required />
                            <br />
<?php
}
?>
                            <label for="input-message"><i class="far fa-file-alt"></i> Mesajın:</label>
